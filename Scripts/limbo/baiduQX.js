...
let rHead = "<head>";
let newStyle =
  '<head><link rel="stylesheet" href="https://gitlab.com/zzzzs3/QuanX/-/raw/main/Css/baidu.css" type="text/css">';
var rBody = "</body>";
var newJavaScript =
  '<script type="text/javascript" async="async" src="https://gitlab.com/zzzzs3/QuanX/-/raw/main/Scripts/limbo/baidu.js"></script>';
